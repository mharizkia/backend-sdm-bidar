    ...
    <table class="w-full table-auto border border-gray-300">
        <thead class="bg-gray-100">
            <tr>
                ...
                <th class="border px-4 py-2">Nama Pewawancara</th>
                <th class="border px-4 py-2">Jabatan Pewawancara</th>
                <th class="border px-4 py-2">Tanggal Wawancara</th>
                <th class="border px-4 py-2">Kesimpulan</th>
                <th class="border px-4 py-2">Hasil Wawancara</th>
            </tr>
        </thead>
        <tbody>
            @forelse ($listWawancara as $index => $w)
                <tr class="{{ $index % 2 == 0 ? 'bg-white' : 'bg-gray-50' }}">
                    ...
                    <td class="border px-4 py-2">{{ $w->nama_pewawancara }}</td>
                    <td class="border px-4 py-2">{{ $w->pewawancara->jabatan_pewawancara ?? '-' }}</td>
