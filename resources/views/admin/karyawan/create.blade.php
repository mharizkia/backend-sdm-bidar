...
@section('content')
    <div class="mb-6">
        <h1 class="text-2xl font-semibold text-text-dark">Tambah Data Karyawan</h1>
        ...
        <form action="{{ route('karyawan.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 gap-y-6">
                ...
                <div>
                    ...
                    <select name="kat_unit_kerja_id" id="kat_unit_kerja_id"
                        ...
                        @foreach($katunitkerja as $unit)
                            <option value="{{ $unit->id }}" {{ old('kat_unit_kerja_id') == $unit->id ? 'selected' : '' }}>{{ $unit->nama_unit }}</option>
                        @endforeach
                    </select>
                </div>
                <div>
                    ...
                    <select name="status_aktivasi" id="status_aktivasi"
                        ...
                        <option value="nonaktif" {{ old('status_aktivasi') == 'nonaktif' ? 'selected' : '' }}>Tidak Aktif</option>
                    </select>
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="file" name="dokumen_karyawan" id="dokumen_karyawan" accept="application/pdf"
                        class="form-input mt-1 block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100 border border-gray-300">
                </div>
            </div>
